<?php
/**
 * become/griff/index.php — Griffin — AI Sales Coach
...
async function sendMessage() {
    ...
    try {
        var res = await fetch('/become/coach/api.php?action=chat', {
            method: 'POST',
...
async function loadHistory() {
    ...
    try {
        var res = await fetch('/become/coach/api.php?action=conversations');
...
async function loadConversation(id) {
    ...
    try {
        var res = await fetch('/become/coach/api.php?action=conversation&id='+id);
...
async function loadDoctrine() {
    ...
    try {
        var res = await fetch('/become/coach/api.php?action=doctrine');
...
async function addDoctrine() {
    ...
    await fetch('/become/coach/api.php?action=doctrine', {
